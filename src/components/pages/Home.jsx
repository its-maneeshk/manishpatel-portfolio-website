  ...
  return (
    <>
      <section className="bg-gray-950 dark:bg-gray-900">
        <div className="px-6 py-40 mx-auto max-w-screen-xl text-center">
          <h1 className="mb-8 text-4xl md:text-6xl font-extrabold tracking-tight leading-tight md:leading-snug text-white">
            The Best <span className="text-orange-500">Technology</span> Is the One That Feels Effortless —
            Just Like <span className="text-orange-500">Great Code</span>, It Works Without
            <span className="text-orange-500"> Being Noticed</span>.
          </h1>
          {/* <p className="text-lg md:text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
            Seamlessly designed solutions should function effortlessly, allowing users to focus on the experience rather than the complexity behind them.
          </p> */}
          <div className="flex flex-col mt-8 lg:mt-12 space-y-4 sm:flex-row sm:justify-center sm:space-y-0 sm:space-x-4">
            <button
              onClick={handleScroll}
              className="inline-flex justify-center items-center py-3 px-6 text-lg font-semibold text-white bg-orange-600 hover:bg-orange-700 rounded-lg shadow-lg transition-all duration-300 focus:ring-4 focus:ring-orange-400"
            >
              Explore More
      ...
      <section class="text-gray-600 body-font">
        <div class="container mx-auto flex px-6 py-24 max-w-screen-xl md:flex-row flex-col items-center">
          <div class="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
            <a href="#" class="inline-flex justify-between items-center py-1 px-1 pr-4 mb-1 text-sm text-gray-700 bg-gray-100 rounded-full dark:bg-gray-800 dark:text-white hover:bg-gray-200 dark:hover:bg-gray-700" role="alert">
            ...
            <h1 class="title-font sm:text-4xl text-3xl mb-4 font-medium text-gray-900">Bridging Technology & Creativity—
              <br class="hidden lg:inline-block" />I'm <span className='text-6xl text-orange-400'>Manish Patel</span>,<br />a CSE Engineer crafting digital solutions that make an impact.
            </h1>
            ...
            <div className='flex justify-center items-center py-2 px-12 rounded-lg border border-gray-300 hover:bg-gray-100 focus:ring-4 focus:ring-gray-100 dark:text-white dark:border-gray-700 dark:hover:bg-gray-700 dark:focus:ring-gray-800'>
      ...
      <section className="bg-gray-800 text-white">
        <div className="max-w-5xl mx-auto px-6 md:px-24 py-16">
          <ol className="relative border-s border-gray-600">
            {timelineData.map((item, index) => (
              <li key={index} className="mb-10 ms-6">
                ...
                <p className="mb-4 text-base text-gray-300">{item.description}</p>
                {item.link && (

        ...
        <section className="p-8 bg-gray-200 flex flex-col justify-center">
            ...
            {visibleRepos.length === 0 ? (
                <div className="flex justify-center items-center my-10">
                    <button disabled type="button" class="text-white w-60 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 inline-flex items-center">
